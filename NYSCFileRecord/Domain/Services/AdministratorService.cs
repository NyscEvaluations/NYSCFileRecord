...
//        public async Task<string> CreateNewUser(ApplicationDbContext _db, User user, AppRole appRole)
//        {
...
//            await administratorRepository.CreateUserRole(_db, user, appRole);
...
//        public async Task<List<AppRole>> GetAppRoles(ApplicationDbContext _db)
//        {
//            var message = string.Empty;

//            var rolesInfo = await administratorQueries.GetAllRoles(_db);
