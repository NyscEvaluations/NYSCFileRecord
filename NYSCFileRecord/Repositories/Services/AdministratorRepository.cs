...
//        public async Task<string> CreateUserRole(ApplicationDbContext _db, User user, AppRole appRole)
//        {
//            var result = string.Empty;
...
//                RoleId = appRole.AppRoleId.ToString()

//            };

//            try
//            {
//                _db.UserAppRole.Add(newRecord);
//                await _db.SaveChangesAsync();
//            }
//            catch (Exception e)
//            {
